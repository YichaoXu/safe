...
case class CFGEnterCode(
  ...
  block: NormalBlock,
  lhs: CFGId,
  thisExpr: CFGExpr) extends CFGNormalInst {
...
case class CFGExprStmt(
  ir: IRNode,
  block: NormalBlock,
  lhs: CFGId, right: CFGExpr) extends CFGNormalInst {
...
case class CFGDelete(
  ...
  block: NormalBlock,
  lhs: CFGId,
  expr: CFGExpr) extends CFGNormalInst {
...
case class CFGDeleteProp(
  ...
  lhs: CFGId,
  obj: CFGExpr,
  index: CFGExpr) extends CFGNormalInst {
...
case class CFGStore(
  ...
  obj: CFGExpr,
  index: CFGExpr,
  rhs: CFGExpr) extends CFGNormalInst {
...
case class CFGFunExpr(
  ...
  var asite3Opt: Option[AllocSite]) extends CFGNormalInst {
  override def toString: String = {
...
case class CFGAssert(
  ...
  block: NormalBlock,
  expr: CFGExpr,
  flag: Boolean) extends CFGNormalInst {
...
case class CFGCatch(
  ir: IRNode,
  block: NormalBlock,
  name: CFGId) extends CFGNormalInst {
...
case class CFGReturn(
  ir: IRNode,
  block: NormalBlock,
  exprOpt: Option[CFGExpr]) extends CFGNormalInst {
  override def toString: String = {
...
case class CFGNoOp(
  ir: IRNode,
  block: NormalBlock,
  desc: String) extends CFGNormalInst {
